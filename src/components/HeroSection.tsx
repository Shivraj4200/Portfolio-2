...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col justify-center relative overflow-hidden pt-16 bg-gradient-to-b from-white to-blue-50"
    >
      {/* Background Elements */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="w-full md:w-3/5">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl">
              B.Tech in Computer Science with expertise in creating scalable applications using modern frontend and
              backend technologies. Committed to delivering efficient solutions and eager to explore emerging tools in
              AI and cloud technologies.
            </p>
            <div className="flex flex-wrap gap-4">
              <Button
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white transition-all duration-300 transform hover:scale-105 flex items-center gap-2 border-none"
                asChild
              >
              ...
              <Button
                variant="outline"
                className="border-2 border-blue-500 text-blue-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300 flex items-center gap-2"
                asChild
              >
